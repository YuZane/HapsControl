...
class HAPSControlGUI:
    ...
    def load_or_create_config(self):
        ...
        config['ResetCommands'] = {
            ...
            'haps_slave': 'emu:8 cfg_reset_pulse FB1_B'
        }
    ...
    def create_widgets(self):
        ...
        # 创建配置项
        self.create_config_entry(conn_frame, "ConfPro路径:", "Connection", "confpro_path", 0)
        self.create_config_entry(conn_frame, "主机地址(IP):", "Connection", "host", 1)
        self.create_config_entry(conn_frame, "SSH端口:", "Connection", "port", 2)
        ...
        config_help = "1. 所有配置将保存在程序目录下的haps_config.ini文件中\n" \
                      ...
                      "4. 预设路径可在主界面修改和保存\n" \
                      "5. 程序使用paramiko库进行SSH连接，无需plink.exe"
    ...
    def create_ssh_client(self):
        ...
        port = int(self.get_config_value('Connection', 'port', 22))
