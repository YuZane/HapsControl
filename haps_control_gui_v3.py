...
class HAPSControlGUI:
    ...
    def create_widgets(self):
        ...
        self.create_config_entry(conn_frame, "主机地址(IP):", "Connection", "host", 2)
        self.create_config_entry(conn_frame, "用户名:", "Connection", "user", 3)
        self.create_config_entry(conn_frame, "密码:", "Connection", "password", 4, show="")  # 明文显示密码
